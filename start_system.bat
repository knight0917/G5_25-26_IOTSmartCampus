...
echo [5/6] Starting Sensor Simulator...
start "Sensor Simulator" cmd /k "call venv\Scripts\activate & python simulator/sensor_simulator.py"

echo [6/7] Starting Actuator Service...
start "Actuator Service" cmd /k "call venv\Scripts\activate & python actuator/actuator_service.py"

echo [7/7] Starting Logger Service...
start "Logger Service" cmd /k "call venv\Scripts\activate & python logger/logger_service.py"
